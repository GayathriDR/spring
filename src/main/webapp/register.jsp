...
<form action="register.odc" method="post" id="form" class="form-inline" style="width:500px;margin:auto">

 <div class="input-group">
   <span class="input-group-addon" id="basic-addon1"> User Name</span></div>
   <br />
   <div>
